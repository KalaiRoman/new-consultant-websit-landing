...
<img src={softwareimage} alt="no image" className='cm'/>
      ...
      Microhaze Technologies delivers cost effective and reliable software development services, from total solution configuration, software development, e-com solutions, e-service implementation & maintenance as per customer needs.
      </div>
      ...
      Microhaze Technologies has completed a number of successful .NET projects for our customers. By using .NET technologies we make sure that our customers get the most advantages from this choice.Our .NET team of developers develops and delivers comprehensive solutions utilizing the full range of .NET functionality.
      </div>
      <div className='mt-4 orange-text mb-2'>
      PHP Software Development
      </div>
      <div className='grey-text mt-2 mb-3'>
      PHP is widely used for developing dynamic, database-driven web pages. Microhaze Technologies has completed a number of successful projects using PHP & MySQL. Our dedicated team of PHP engineers will develop reliable and scalable solutions as per your requirements.
      </div>
      <div className='mt-4 orange-text mb-2'>
      JAVA Development
      </div>
